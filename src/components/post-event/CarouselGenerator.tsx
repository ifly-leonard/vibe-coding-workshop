    ...
    <div className="flex min-h-0 flex-1 flex-col">
      ...
      <div className="flex flex-1 flex-col items-center justify-center gap-5">
        <div
          ...
          style={{ maxWidth: MAIN_PREVIEW_MAX }}
        >
          <div
            className={
              activeSlide?.hidden
...
export function CarouselGenerator({
  ...
  const missingSessionInstructors: SessionInstructor[] = (["hameed", "leo", "hari"] as const).filter(
    (instructor) => !hasSessionSlide(slides, instructor),
  );
                        ...
                        {slide.type === "content" ? (
                          ...
                          <div className="space-y-3">
                            <p className="text-sm text-[color:var(--text-muted)]">
                              Upload a photo for the polaroid and enter your certificate ID. You can
                              hide or delete this slide if you do not need it.
                            </p>
                            <label className="block">
                              <span className="mb-1.5 block text-xs font-semibold uppercase tracking-wide text-[color:var(--text-soft)]">
                                Certificate ID
                            ...
                            <label className="flex cursor-pointer items-center gap-4 rounded-xl border border-dashed border-[color:var(--border)] bg-[color:var(--bg-card)] px-4 py-3 transition hover:border-[color:var(--accent-vermillion)]/40">
                              <div className="flex h-16 w-14 shrink-0 items-center justify-center overflow-hidden rounded-sm border border-[color:var(--border)] bg-white shadow-sm">
                                {polaroidUrl ? (
                                  <img src={polaroidUrl} alt="" className="h-full w-full object-cover" />
                                ) : (
                                  <ImagePlus className="h-5 w-5 text-[color:var(--text-soft)]" />
                                )}
                              </div>
            ...
            <div>
              ...
              <div className="mt-3 grid gap-3 sm:grid-cols-2">
                ...
                >
                  ...
                  <span className="block text-xs text-[color:var(--text-muted)]">PDF carousel</span>
                </button>
                <button
                  type="button"
